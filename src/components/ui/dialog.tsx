...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      className={cn(
        "data-open:fade-in-0 data-closed:fade-out-0 fixed inset-0 isolate z-50 bg-[color:var(--c-overlay)] duration-100 data-closed:animate-out data-open:animate-in",
        className
      )}
